CREATE TABLE `equipment` (
	...
	CONSTRAINT "equipment_status_check" CHECK("equipment"."status" in ('available', 'infrastructure', 'checked-out')),
	CONSTRAINT "equipment_quantity_check" CHECK("equipment"."quantity" >= 1 and "equipment"."quantity" <= 10000)
);
--> statement-breakpoint
INSERT INTO equipment (id,status,assigned_to,display_name,record_date,category,location,part_number,serial_number,quantity,vendor,notes) VALUES
